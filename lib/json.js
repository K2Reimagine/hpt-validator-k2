 ...
 */
export async function validateJson(jsonInput, version, options = {}, mode, outputFilePath, clarifyInfo) {
    if (version === "v1.1") {
        return JsonValidatorOneOne.validateJson(jsonInput, options);
    }
    else if (version === "v2.0" || version === "v2.0.0") {
        return JsonValidatorTwoZero.validateJson(jsonInput, options, mode, outputFilePath, clarifyInfo);
    }
