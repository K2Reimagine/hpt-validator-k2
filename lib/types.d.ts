...
export declare const SCHEMA_VERSIONS: readonly ["v1.1", "v2.0"];
...
export interface JsonValidatorOptions {
    maxErrors?: number;
    onValueCallback?: (val: JsonTypes.JsonPrimitive | JsonTypes.JsonStruct) => void;
}
export interface JsonValidatorVersion {
    validate: (jsonInput: File | NodeJS.ReadableStream, options: JsonValidatorOptions) => Promise<ValidationResult>;
}
export declare const STATE_CODES: readonly ["AL", "AK", "AS", "AZ", "AR", "CA", "CO", "CT", "DE", "DC", "FL", "GA", "GU", "HI", "ID", "IL", "IN", "IA", "KS", "KY", "LA", "ME", "MD", "MA", "MI", "MN", "MS", "MO", "MT", "NE", "NV", "NH", "NJ", "NM", "NY", "NC", "ND", "MP", "OH", "OK", "OR", "PA", "PR", "RI", "SC", "SD", "TN", "TX", "UT", "VT", "VI", "VA", "WA", "WV", "WI", "WY"];
